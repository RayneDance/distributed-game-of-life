...
- [x] **Task 2.3: Chunk Actor Registry.** Manage active chunk goroutines in memory and route ticks/events to them.

## Phase 3: Network & API (The Gateway)
- [x] **Task 3.1: WebSocket Server.** Scaffold a generic WebSocket handler for client connections.
...
- [x] **Task 4.1: Web Canvas.** Create a minimal HTML5/JS canvas to render a 3x3 chunk viewport.
- [x] **Task 4.2: Client Sync.** Implement WebSocket client to receive state and send mutations.